...
class _FoodDeliveryScreenState extends State<FoodDeliveryScreen> {
  final List<FoodItem> _foodItems = const [
    FoodItem(
      ...
      duration: '15-20 min',
      price: 12.99,
      description: 'Two grass-fed beef patties, double Swiss cheese, caramelized onions, and black truffle aioli on a brioche bun.',
    ),
    FoodItem(
      id: '2',
      ...
      duration: '20-25 min',
      price: 15.50,
      description: 'Slow-fermented sourdough crust, san marzano tomato sauce, fresh mozzarella, spicy pepperoni, and hot honey drizzle.',
    ),
    FoodItem(
      id: '3',
      ...
      duration: '10-15 min',
      price: 14.25,
      description: 'Grilled salmon fillet, organic brown rice, avocado, pickled ginger, seaweed salad, and signature sesame soy dressing.',
    ),
    FoodItem(
      id: '4',
      name: 'Gourmet Matcha Waffles',
      imageUrl: 'https://images.unsplash.com/photo-1564759974727-41b97e3434ac?auto=format&fit=crop&w=600&q=80',
      rating: 4.6,
      duration: '15-20 min',
      price: 9.99,
      description: 'Fluffy green tea waffles topped with fresh organic strawberries, wild berry compote, and pure maple syrup.',
    ),
  ];
          ...
          CurvedAppBarAction(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Search dishes')),
              );
            },
          ),
          CurvedAppBarAction(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Open cart containing $cartCount items')),
              );
            },
          ),
        ],
                            ...
                            Image.network(
                              ...
                              errorBuilder: (context, error, stackTrace) {
                                return Container(
                                  ...
                                  child: const Center(
                                    child: Icon(Iconsax.coffee, size: 40, color: Colors.deepOrange),
                                  ),
                                );
                              },
                            ),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Icon(Iconsax.truck_fast, size: 16, color: Colors.grey[500]),
                                  const SizedBox(width: 4),
                                  Text(
                                    'Free Delivery',
                                    style: TextStyle(
                                ...
                                children: [
                                  ...
                                  if (count == 0)
                                    ElevatedButton(
                                      ...
                                      child: const Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 6),
                                          Text('Add to Order', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                                        ],
                                      ),
                                    )
                                  else
                                    Row(
                                      children: [
                                        IconButton(
                                          onPressed: () => _removeFromCart(food.id),
